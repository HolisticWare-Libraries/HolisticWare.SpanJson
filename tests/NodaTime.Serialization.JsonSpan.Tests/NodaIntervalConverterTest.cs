namespace NodaTime.Serialization.JsonSpan.Tests
{
    ...
    public class NodaIntervalConverterTest
    {
        ...
        public void Deserialize_CaseInsensitive()
        {
            ...
            string json1 = "{\"interval\":{\"Start\":\"2012-01-02T03:04:05Z\",\"End\":\"2013-06-07T08:09:10Z\"}}";

            var testObjectPascalCase = JsonSerializer.Generic.Utf16.Deserialize<TestObject, NodaExcludeNullsOriginalCaseResolver<char>>(json);
            var testObjectCamelCase = JsonSerializer.Generic.Utf16.Deserialize<TestObject, NodaExcludeNullsCamelCaseResolver<char>>(json1);
