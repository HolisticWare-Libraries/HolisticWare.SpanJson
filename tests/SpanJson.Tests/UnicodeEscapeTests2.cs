...
namespace SpanJson.Tests
{
    public class UnicodeEscapeTests2
    {
        ...
        public void ToStringStringEscapeHandling()
        {
            ...
            Assert.Equal(@"<b>hi " + '\u20AC' + @"</b>", JsonHelpers.EscapeValue(v));

            json = JsonEncodedText.Encode(v, JsonEscapeHandling.EscapeHtml);
            Assert.Equal(@"\u003cb\u003ehi " + '\u20AC' + @"\u003c/b\u003e", json.ToString());
            Assert.Equal(@"\u003cb\u003ehi " + '\u20AC' + @"\u003c/b\u003e", JsonHelpers.EscapeValue(v, JsonEscapeHandling.EscapeHtml));

            json = JsonEncodedText.Encode(v, JsonEscapeHandling.EscapeNonAscii);
            Assert.Equal(@"\u003cb\u003ehi \u20ac\u003c/b\u003e", json.ToString(), ignoreCase: true);
            Assert.Equal(@"\u003cb\u003ehi \u20ac\u003c/b\u003e", JsonHelpers.EscapeValue(v, JsonEscapeHandling.EscapeNonAscii), ignoreCase: true);
        }
        ...
        public void EscapeJavaScriptString_UnicodeLinefeeds()
        {
            ...
            var escapedString = JsonHelpers.EscapeValue(text0085, JsonEscapeHandling.Default);
            Assert.Equal(@"before\u0085after", escapedString);

            escapedString = JsonHelpers.EscapeValue(text2028, JsonEscapeHandling.Default);
            Assert.Equal(@"before\u2028after", escapedString);

            escapedString = JsonHelpers.EscapeValue(text2029, JsonEscapeHandling.Default);
            Assert.Equal(@"before\u2029after", escapedString);
        ...
        {
            var escapedString = JsonHelpers.EscapeValue("How now brown cow?",  JsonEscapeHandling.Default);
            Assert.Equal(@"How now brown cow?", escapedString);

            escapedString = JsonHelpers.EscapeValue("How now 'brown' cow?",  JsonEscapeHandling.Default);
            Assert.Equal(@"How now 'brown' cow?", escapedString);

            escapedString = JsonHelpers.EscapeValue("How now <brown> cow?",  JsonEscapeHandling.Default);
            Assert.Equal(@"How now <brown> cow?", escapedString);

            escapedString = JsonHelpers.EscapeValue("How \r\nnow brown cow?",  JsonEscapeHandling.Default);
            Assert.Equal(@"How \r\nnow brown cow?", escapedString);

            escapedString = JsonHelpers.EscapeValue("\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007",  JsonEscapeHandling.Default);
            Assert.Equal(@"\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007", escapedString);

            escapedString =
                JsonHelpers.EscapeValue("\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013", JsonEscapeHandling.Default);
            Assert.Equal(@"\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013", escapedString);

            escapedString =
                JsonHelpers.EscapeValue(
            ...
            escapedString = JsonHelpers.EscapeValue("^_`abcdefghijklmnopqrstuvwxyz{|}~", JsonEscapeHandling.Default);
            ...
            escapedString = JsonHelpers.EscapeValue(data, JsonEscapeHandling.Default);
            Assert.Equal(expected, escapedString);

            escapedString = JsonHelpers.EscapeValue("Fred's cat.", JsonEscapeHandling.Default);
            Assert.Equal(@"Fred's cat.", escapedString);

            escapedString = JsonHelpers.EscapeValue(@"""How are you gentlemen?"" said Cats.", JsonEscapeHandling.Default);
            ...
            escapedString = JsonHelpers.EscapeValue("\u001farray\u003caddress", JsonEscapeHandling.Default);
