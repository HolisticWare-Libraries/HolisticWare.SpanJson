...
public sealed class DynamicUtf16StringConverter : Newtonsoft.Json.JsonConverter
{
    public static readonly DynamicUtf16StringConverter Instance = new();

    private DynamicUtf16StringConverter() { }
