// borrowed from https://github.com/dotnet/runtime/blob/4aeec6397c7dd6198129219ed806f93d6ed675c0/src/libraries/Common/src/System/HexConverter.cs#L15
...
#if NET || NETCOREAPP3_1_OR_GREATER
...
namespace SpanJson.Internal
{
    internal static class HexConverter
    {
...
#if NET || NETCOREAPP3_1_OR_GREATER
        private static void EncodeToUtf16_Ssse3(in ReadOnlySpan<byte> bytes, Span<char> chars, Casing casing)
        {
        ...
        public static void EncodeToUtf16(in ReadOnlySpan<byte> bytes, Span<char> chars, Casing casing = Casing.Upper)
        {
        ...
        [System.Security.SecuritySafeCriticalAttribute]
#endif
        public static unsafe string ToString(in ReadOnlySpan<byte> bytes, Casing casing = Casing.Upper)
        {
        ...
        public static bool TryDecodeFromUtf16(in ReadOnlySpan<char> chars, Span<byte> bytes)
        {
            return TryDecodeFromUtf16(chars, bytes, out _);
        }

        public static bool TryDecodeFromUtf16(in ReadOnlySpan<char> chars, Span<byte> bytes, out int charsProcessed)
        {
        ...
        {
            return (uint)(c - '0') <= 9u || (uint)(c - 'A') <= ('F' - 'A');
        }
